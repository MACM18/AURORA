...
if ($data != null) {
    $query2 = "UPDATE checker SET User='$userName',Good='$good',Bad='$bad' WHERE operator='$operator'";
} else {
    $query2 = "INSERT INTO checker(User,Date,Good,Bad,operator) VALUES('$userName','$date','$good','$bad','$operator')";
}
